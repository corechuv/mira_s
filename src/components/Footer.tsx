...
export default function Footer(){
  return (
    <footer className="container" style={{padding:"28px 0",borderTop:"1px solid var(--border)",marginTop:28,display:"grid",gap:12}}>
      <div className="logo"><span className="dot"></span><b>Marketplace</b></div>
      ...
      <small style={{color:"var(--muted)"}}>© {new Date().getFullYear()} Marketplace. Чистый React + TS + Vite. Цвета: розовый, чёрный, белый.</small>
